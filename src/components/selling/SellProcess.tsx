...
const simplifiedSteps = [
  {
    id: 'step-1',
    title: 'Basisdaten eingeben',
    description: 'Füllen Sie das Formular mit den wichtigsten Fahrzeugdaten aus.'
  },
  {
    id: 'step-2',
    title: 'Preisschätzung bekommen',
    description: 'Erhalten Sie innerhalb von 24 Stunden ein faires Angebot.'
  },
  {
    id: 'step-3',
    title: 'Schnell und einfach verkaufen',
    description: 'Wir kümmern uns um alles Weitere – stressfrei für Sie.'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            In nur 3 einfachen Schritten zu Ihrem fairen Angebot. 
